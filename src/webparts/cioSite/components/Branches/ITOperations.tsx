...
<div className="panel-heading">
    <ul className="tree">
        <li>
            <span className="sttp" title="Cyber Security"> IT Operations</span>
            <ul>
                <li>
                    <span className="stts" title="Enterprise Mission Support Branch">Project Authorization & Requirements Sect</span>
                    <ul>
                ...
                <li>
                    <span className="stts" title="IT Investment Management Branch ">IT Investment Management Branch </span>
                    <ul>
                        <li> <span className="sttl" title="CPIC Oversight Section">Project Authorization & Requirements Sect</span></li>
...
<h1>Links wil be placed here</h1>
</div>
</div>
